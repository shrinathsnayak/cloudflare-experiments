...
<TypeTable
  type={{
    url: {
      description: "The website URL to render (must be http or https)",
      type: "string",
      required: true,
    },
  }}
...
- **[Puppeteer `page.pdf()`](https://developers.cloudflare.com/browser-rendering/platform/puppeteer/)** - PDF generation from rendered pages
