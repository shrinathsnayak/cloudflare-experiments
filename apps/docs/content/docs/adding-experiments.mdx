...
### Implement the Worker
    ...
    Follow the [code standards](/docs/code-standards) to implement your Worker:
...
- Review the [Code Standards](/docs/code-standards) for implementation details
- Check the [Contributing Guide](/docs/contributing) for PR guidelines
