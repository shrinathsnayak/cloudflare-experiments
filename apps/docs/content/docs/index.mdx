...
<Cards>
  ...
  <Card title="Browse Experiments" href="/experiments/ai-website-summary">
    Explore 35+ edge computing experiments
  </Card>
...
<Cards>
  <Card title="Workers AI">Summarization, translation, sentiment, embeddings, and image generation</Card>
  <Card title="Browser Rendering">Screenshot capture, PDF export, and browser automation</Card>
  <Card title="Edge Networking">DNS lookup, monitoring, geolocation, and redirect tracing</Card>
  <Card title="HTMLRewriter">Web scraping, parsing, and HTML transformation at the edge</Card>
  <Card title="D1, KV & Vectorize">Edge databases, key-value storage, and semantic search</Card>
