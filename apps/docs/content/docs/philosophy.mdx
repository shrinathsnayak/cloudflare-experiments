...
<Cards>
  ...
  <Card title="Task Queue">Reference pattern: async processing with Queues producer/consumer</Card>
  <Card title="Link Shortener">Reference pattern: D1 primary storage with KV read cache</Card>
