...
### Choose an experiment
    ...
    Browse the [available experiments](/docs/experiments) and pick one to deploy. For this guide, we'll deploy [Where Am I](/docs/experiments/whereami), which returns geolocation data from Cloudflare's edge.
...
All experiments are **stateless first** and use edge compute, fetch, and HTML parsing without requiring persistent storage. Learn more about the design [philosophy](/docs/philosophy).
...
<Cards>
  <Card title="Explore Experiments" href="/docs/experiments">
